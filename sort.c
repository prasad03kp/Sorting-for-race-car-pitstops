...
void scene3()
{
	...
	glColor3f(0,0,0);
	char b[]="THANK YOU!!!";
	glRasterPos2f(-18,573);
	for(int k=0;k<strlen(b);k++)
        	glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_24,b[k]);
...
void for_car8(){
	for(rev=400;rev<950;rev+=10)
		scene2();
}
void for_car9(){
	for(rev=400;rev<580;rev+=10)
		scene2();
}
